        ...
        for index, chromosome in enumerate(self.chromosomes):
            if (chromosome.fitness == -1):
                ...
                for agentTrace in self.agentTraces:
                    ...
                    df_ = sim_sis.RunSimulator(self.space, self.rooms, agentTrace, chromosome.GetSensorConfiguration() , simulateMotionSensors, simulateEstimotes, Plotting , self.Data_path)
...
def Train(Data_path, bestChromosome):
    ...
    for agentTrace in agentTraces:
        filecoding = ' '#"_" + str(iteration) + "_c" + str(index + 1) + '(' + self.mode + ')'
        df_ = sim_sis.RunSimulator(space, rooms, agentTrace, bestChromosome.GetSensorConfiguration() , simulateMotionSensors, simulateEstimotes, Plotting , Data_path)
       ...
       print_epochs = False
        ...
        for epsilon in [1]:
            ...
            for epoch in range(iteration):
                ...
                results.append([c.fitness + sum(c.grid / 100) * 100 for c in ga.chromosomes])
