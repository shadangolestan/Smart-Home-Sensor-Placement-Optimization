...
space = [(0.0, 0.0), (0.0, 8.3), (8.6, 8.6), (8.6, 0.0)]
rooms = {'bedroom': [(3.9, 0.0), (8.6, 4.4)],
         'livingroom': [(0.0, 1.9), (6.3, 6.7)],
         'diningroom': [(0.0, 3.0), (2.9, 8.6)],
         'kitchen': [(0.0, 3.0), (2.9, 8.6)],
         'bathroom': [(6.1, 3.2), (8.6, 6.7)],
		 'storage': [(2.8, 6.4), (8.6, 8.6)]} 
